...
export default function Search<T>({
  ...
  return (
    <div className={classes.rootMain}>
      ...
      <Paper variant="outlined" style={{padding: 15, borderRadius: 30 }}>
        ...
        {filters && (
          <div className={classes.chipsContainer}>
            {Object.keys(filters).map((key, index) => {
              if (chipFormat[key]?.formatAll) {
                return chipFormat[key].formatAll(
              ...
              const chipComponent = (
                <Chip
                  ...
                  label={`${
                    ...
                    chipFormat[key]?.formatValue
                      ? chipFormat[key].formatValue(filters[key])
                      : filters[key]
                  }`}
                  onClick={toggleDrawer(true)}
                  onDelete={() => removeFilter(key)}
